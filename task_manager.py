...
def save_tasks(tasks): # [{'name': '수업끝나고 맛있는거 먹을래요', 'completed': False},]
...
def add_task(task_name):
    tasks = load_tasks() # => tasks = [{'name': '수업끝나고 맛있는거 먹을래요', 'completed': False},]
    task = {'name': task_name, 'completed': False} # {'name': '수업끝나고 맛있는거 먹을래요', 'completed': False}
    tasks.append(task)
    save_tasks(tasks)# tasks = [{'name': '수업끝나고 맛있는거 먹을래요', 'completed': False},]
